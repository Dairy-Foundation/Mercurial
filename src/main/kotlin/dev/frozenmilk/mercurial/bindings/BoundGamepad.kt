...
class BoundGamepad(gamepad: PasteurizedGamepad<EnhancedDoubleSupplier, EnhancedBooleanSupplier>) : PasteurizedGamepad<BoundDoubleSupplier, BoundBooleanSupplier> {
	...
	/**
	 * left analog stick horizontal axis as boolean (not 0)
	 */
	@get:JvmName("booleanLeftStickX")
	@set:JvmName("booleanLeftStickX")
	var booleanLeftStickX = BoundBooleanSupplier { abs(gamepad.leftStickX.state) > 0.1 }

	/**
	 * left analog stick vertical axis as boolean (not 0)
	 */
	@get:JvmName("booleanLeftStickY")
	@set:JvmName("booleanLeftStickY")
	var booleanLeftStickY = BoundBooleanSupplier { abs(gamepad.leftStickY.state) > 0.1 }

	/**
	 * right analog stick horizontal axis as boolean (not 0)
	 */
	@get:JvmName("booleanRightStickX")
	@set:JvmName("booleanRightStickX")
	var booleanRightStickX = BoundBooleanSupplier { abs(gamepad.rightStickX.state) > 0.1 }

	/**
	 * right analog stick vertical axis as boolean (not 0)
	 */
	@get:JvmName("booleanRightStickY")
	@set:JvmName("booleanRightStickY")
	var booleanRightStickY = BoundBooleanSupplier { abs(gamepad.rightStickY.state) > 0.1 }
	...
	/**
	 * boolean left trigger
	 */
	@get:JvmName("booleanLeftTrigger")
	@set:JvmName("booleanLeftTrigger")
	var booleanLeftTrigger = BoundDoubleSupplier(gamepad.leftTrigger).conditionalBindState().greaterThan(0.1).bind()

	/**
	 * boolean right trigger
	 */
	@get:JvmName("booleanRightTrigger")
	@set:JvmName("booleanRightTrigger")
	var booleanRightTrigger = BoundDoubleSupplier(gamepad.rightTrigger).conditionalBindState().greaterThan(0.1).bind()
